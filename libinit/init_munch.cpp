...
static const variant_info_t munch_in_info = {
    ...
    .mod_device = "munch_in_global",
    .model = "22021211RI",
    .build_fingerprint = "POCO/munch_in/munch:13/RKQ1.211001.001/V14.0.3.0.TLMMIXM:user/release-keys",
...
static const variant_info_t munch_global_info = {
    ...
    .mod_device = "munch_global",
    .model = "22021211RG",
    .build_fingerprint = "POCO/munch_global/munch:13/RKQ1.211001.001/V14.0.3.0.TLMMIXM:user/release-keys",
